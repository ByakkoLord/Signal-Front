...
export default function Sidebar() {
  return (
    <div className="backgroundTest sidebar">
      <div style={{ width: '100%', background: "linear-gradient(to right,rgb(70, 70, 70),rgb(5, 60, 81))", height: 60, marginTop: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
